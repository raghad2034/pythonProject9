...
class PetInventory:
    def __init__(self, name, owner, pet_type, gender, service, days):
        self.name = name
        self.owner = owner
...
class GUI:
    ...
    def calculate_price(self):
        pet = PetInventory(self.e1.get(), self.e2.get(), self.pet_type_var.get(), self.gender_var.get(), self.service_var.get(), int(self.e3.get()))
        pet.calculate_price()
